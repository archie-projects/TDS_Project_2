...
data_files = []
    ...
    logger.info(f"Starting analysis with {len(data_files)} files. Questions: {questions_content[:100]}...")
    ...
    logger.error(f"Top-level analysis error: {e}\n{traceback.format_exc()}")
    raise HTTPException(status_code=500, detail=f"An unexpected error occurred: {str(e)}")
--- Other Endpoints and Main Runner (No Changes) ---
@app.post("/api/ask")
