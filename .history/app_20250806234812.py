            ...
            for i, step in enumerate(plan.get("plan", [])):
                ...
                try:
                    ...
                    if main_df is None:
                        ...
                        if is_scrape_in_plan and action == "scrape_website":
                        ...
                        elif not is_scrape_in_plan and uploaded_files:
    ...
    async def analyze(self, questions: str, files: List[UploadFile]) -> Any:
        ...
        for file in files:
            if file.filename != "questions.txt":
                # This is where the error occurred. self.temp_dir is needed here.
